...
import { duplicateSection } from '@/lib/cms/xmlEngine';
...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  const cloneId = duplicateSection(params.section, auth.session.username);
  return NextResponse.json({ success: true, cloneId });
}
